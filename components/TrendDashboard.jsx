...
function makeSpark(min = 3, max = 25, n = 14) {
...
const SAMPLE_TRENDS = [
  {
    label: "Silver mini shoulder bag",
    path: ["Accessories", "Handbags", "Party bags"],
    region: "FR",
    last7: 18,
    prev7: 5,
    growth: 13,
  ...
  {
    label: "Ballet flats • satin",
    path: ["Accessories", "Shoes", "Flat Shoes"],
    region: "DE",
    last7: 25,
    prev7: 15,
    growth: 10,
  ...
  {
    label: "Stacked gold huggies",
    path: ["Accessories", "Jewellery", "Gold Jewellery"],
    region: "US",
    last7: 12,
    prev7: 2,
    growth: 10,
  ...
  {
    label: "Denim maxi skirt",
    path: ["RTW Womens", "Denim"],
    region: "UK",
    last7: 30,
    prev7: 32,
    growth: -2,
  ...
  {
    label: "Apres‑ski puffer scarf",
    path: ["Sports", "Apres Ski / Ski"],
    region: "CH",
    last7: 9,
    prev7: 1,
    growth: 8,
  ...
  {
    label: "Workwear tote • structured",
    path: ["Accessories", "Handbags", "Workwear handbags"],
    region: "FR",
    last7: 20,
    prev7: 8,
    growth: 12,
  ...
  // Cultural Translators demo
  {
    label: "Glossy → patent accessories",
    path: [
      "Cultural Translators",
      "Design objects",
      "Surface Finishes: glossy vs matte",
  ...
  {
    label: "Organic curves → bias‑cut dresses",
    path: [
      "Cultural Translators",
      "Design objects",
      "Shape Language: organic vs geometric",
  ...
  {
    label: "Ceramic glaze blues → denim washes",
    path: ["Cultural Translators", "Design objects", "Ceramics"],
    region: "FR",
    last7: 9,
    prev7: 2,
    growth: 7,
  ...
  {
    label: "Modular furniture lines → paneled outerwear",
    path: ["Cultural Translators", "Interiors & architecture", "Modular furniture"],
    region: "DE",
    last7: 11,
    prev7: 3,
    growth: 8,
  ...
  {
    label: "Earth‑tone interiors → muted palettes",
    path: ["Cultural Translators", "Interiors & architecture", "Tones"],
    region: "UK",
    last7: 8,
    prev7: 1,
    growth: 7,
